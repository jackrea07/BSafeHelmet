//controls the bsafe bluetooth stuff 
//based on ble_compatability_test.c from espressif IDF examples project
/*  
    Note that GATT refers to generic ATTribute profile
...
#define SAMPLE_DEVICE_NAME          "BSAFE_BLE_TEST"
...
static const uint16_t CHAR_1_SHORT_R              = 0xFF01;
...
static const uint8_t char1_name[]  = "Char_1_Short_R";
...
static const esp_gatts_attr_db_t gatt_db[HRS_IDX_NB] =
{
    ...
    [IDX_CHAR_VAL_A] =
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&CHAR_1_SHORT_R, ESP_GATT_PERM_READ,
    ...
    switch (event) {
        ...
        case ESP_GATTS_READ_EVT:
            ...
            if(gatt_db_handle_table[IDX_CHAR_VAL_A] == param->read.handle) {
                ...
                //esp_ble_gatts_send_indicate(gatts_if, param->read.conn_id, gatt_db_handle_table[IDX_CHAR_VAL_A], sizeof(message), message, false);
